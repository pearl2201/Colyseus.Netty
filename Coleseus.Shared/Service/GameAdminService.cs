...
namespace Coleseus.Shared.Service
{
    ...
    public interface IGameAdminService
    {
		 ...
		 */
        Object loadGame(long gameId, String gameName);
		 ...
		 */
        Object unLoadGame(long gameId, String gameName);
		 ...
		 *         boolean suggesting success(true) or failure(false).
		 */
        Object loadGameRoom(IGame game, long gameRoomId, String gameRoomName);
		 ...
		 */
        void unloadGameRoom(GameRoom gameRoom);
		 ...
		 *         boolean suggesting success(true) or failure(false).
		 */
        Object unloadGameRoom(IGame game, long gameRoomId);
		 ...
		 *         boolean suggesting success(true) or failure(false).
		 */
        Object unloadGameRoom(IGame game, String gameRoomName);
